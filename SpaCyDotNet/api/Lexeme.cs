...
namespace SpaCyDotNet.api
{
    ...
    {
        private readonly dynamic _pyLexeme;
        ...
        public BigInteger Orth => Interop.GetBigInteger(_pyLexeme?.orth, ref _orth);

        public bool IsAlpha => Interop.GetBool(_pyLexeme?.is_alpha, ref _isAlpha);

        public bool IsDigit => Interop.GetBool(_pyLexeme?.is_digit, ref _isDigit);

        public bool IsTitle => Interop.GetBool(_pyLexeme?.is_title, ref _isTitle);
